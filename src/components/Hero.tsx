...
const Hero = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-800 overflow-hidden">
      ...
      <div className="absolute inset-0 animate-fade-in [animation-delay:0.2s]">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 flex flex-col items-center text-center">
        <div className="max-w-4xl">
          ...
          {/* Heading */}
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight animate-slide-in">
            DevOps
          ...
          {/* Description */}
          <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed animate-slide-in [animation-delay:0.15s]">
          ...
          {/* Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-slide-in [animation-delay:0.3s]">
          ...
          {/* Stats */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 animate-slide-in [animation-delay:0.45s]">
